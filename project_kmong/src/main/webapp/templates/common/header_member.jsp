...
$(function(){
	$("#logoutBtn").click(function(){
		$("#loginFrm1").submit();
		//loginFrm1
		//location.replace("http://211.63.89.132/templates/home/logout_action.jsp");
	})
        ...
        <div class="header1">
            <a href="http://211.63.89.132/templates/home/index.jsp"><div class="logo-div"></div></a>
               ...
               <div style="width: 250px;" class="buttons"> 
                <form action="http://211.63.89.132/templates/home/logout_action.jsp" method="get" id="loginFrm1">
				...
				<input type="hidden" name="url" value="<%=url%>"/>
                    ...
                    <div style="width: 270px; margin-right: 20px;">
                        <input type="button" value="마이계약" class="my-contract-btn" style="margin-left: 10px;" onclick="location.href='http://211.63.89.132/templates/order_expert/management.jsp'">
                    </div>
                    ...
                    <div class="dropdown" style="width: 40px; border-radius: 50px;" >
                        ...
                        if(session.getAttribute("login")!=null){
	                        ...
	                        if(fileName!=null){
	                        	%><img id="profileImgfile" src="http://211.63.89.132/static/upload/<%=fileName%>" onerror="this.src='http://211.63.89.132/templates/common/default_profile.png';" class="profile" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50px; transition: border 0.2s ease 0s;"/><%
	                        }else{
	                        	%> <img id="profileImgfile" src="http://211.63.89.132/static/upload/default_profile.png" onerror="this.src='http://211.63.89.132/templates/common/default_profile.png';" class="profile" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50px; transition: border 0.2s ease 0s;"/><% 
	                        }
                        }
                        %>
                        </div>
                       ...
                       <!-- 카테고리 메뉴 DB에서 불러오기 -->
                        <a href="http://211.63.89.132/templates/mypage/verification.jsp?service=info"  style="font-size: 13px;">나의 정보</a>
                        <a href="http://211.63.89.132/templates/mypage/verification.jsp?service=pass" style="font-size: 13px;">비밀번호 변경</a>
                        <a href="http://211.63.89.132/templates/mypage/verification.jsp?service=withdraw" style="font-size: 13px;">회원 탈퇴</a>
                        </div>
                    </div>
