...
<%
					...
					Paging paging = new PageImpl(request,llist);
...
<div>
<img src="${search1.postImg }" style="height:130px; width:100%"/>
</div>
<div>
<div style="margin-top: 10px">
<h3 data-testid="title" class="css-10894jy" ><c:out value="${search1.title}"/></h3>
</div>
...
<div>
<img src="http://211.63.89.134/project_kmong/static/images/daum_logo.png" style="height:130px; width:100%"/>
</div>
<div>
<div style="margin-top: 10px">
