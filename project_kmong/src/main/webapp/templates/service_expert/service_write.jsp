         ...
         <div style="float: right; width: 550px" class="header1">
			...
			<div class="main-div" style="flex-direction: column;">
				<div class="main-div">		
					...
					<input placeholder="서비스를 잘 드러낼 수 있는 제목을 입력해주세요" maxlength="30" type="text" autocomplete="off" class="input-element" id="lengthNum1"> 
				...
				<div class="main-div">
					...
					<div>
					<select id="category" name="category" style="width: 500px; height: 40px; border: 0px; font-size: 16px;">
				...
				<div style="flex-direction: row">
					...
					<div class="div-element">
						<input placeholder="기업웹사이트" maxlength="30" type="text" autocomplete="off" class="input-element" id="lengthNum2"> 
				...
				<div class="main-div">
					...
					<div class="div-element">
					<textarea placeholder="- 메인페이지 시안 1개 제공 &#13;&#10;- 공지사항,FAQ페이지 &#13;&#10;- SNS로그인 연동" maxlength="60" autocomplete="off" id="explain-ta"> 
					</textarea>
				...
				<div class="main-div">
					...
					<div class="div-element">
					<input placeholder="금액" maxlength="30" type="text" autocomplete="off" class="input-element"> 
					<span>원</span>
					</div> 
					</div>
				<div class="main-div">
				...
				<div class="main-div">
					...
					<div class="div-element" >
					<textarea id="summernote" name="ta" style="overflow: auto">
					</textarea>
					</div> 
					</div>		
					</div>			
