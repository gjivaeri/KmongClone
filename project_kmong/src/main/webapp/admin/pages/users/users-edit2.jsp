                ...
                <div class="card-body">
                  ...
                  <form class="form-sample">
                    ...
                    <div class="form-group col-md-7">
                      ...
                      <input type="text" class="form-control" id="email" placeholder="user email" value="user1@naver.com">
                    </div>

                    <div class="form-group col-md-7">
                      <label for="nickname">Nickname</label>
                      <input type="text" class="form-control" id="nickname" placeholder="user Nickname" value="user1">
                    </div>
