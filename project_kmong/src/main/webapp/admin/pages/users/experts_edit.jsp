...
if(request.getQueryString() == null){
	response.sendRedirect("http://localhost/project_kmong/admin/pages/users/experts.jsp");
	return;
}
int memberId = Integer.parseInt(request.getParameter("id"));
AdminMemberDAO amDAO = AdminMemberDAO.getInstance();
AdminMemberVO amVO = amDAO.selectMember(memberId, "Y");
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  ...
                  <div class="card-body">
                      <h4 class="card-title mb-1">Expert Edit</h4>
                    ...
                    <div class="row">
                      <div class="col-12">
						...
						<form action="users_edit_pro.jsp" method="get" id="frm">
						    <input type="text" value="true" name="isExpert" style="display:none">
